...
export function ADDatePicker({
  ...
  // If the parent's value changes, mirror it into the calendar view.
  useEffect(() => {
  ...
  // Trim trailing empty weeks so months with fewer rows don't waste space
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            {/* Header — month + AD year, no locale dependency */}
            ...
            <div className="px-4 py-2 bg-slate-50 border-t border-slate-200 flex justify-between items-center">
              ...
              >
                วันนี้ ({fmtISO(todayY, todayM, todayD)})
              </button>
            </div>
          </div>
        </div>
